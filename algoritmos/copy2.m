...
for i = 1:5
    ...
    for t = 0:6:24
        ...
        for n = 0:29
            if w ~=i    
                copyfile(sprintf('Vitoria/v_%dh_%d.jpg',t,n+1),sprintf('Treino%d/treino/%d',i,k)); 
                copyfile(sprintf('Red Globe/R_%dh_%d.jpg',t,n+1),sprintf('Treino%d/treino/%d',i,k)); 
                copyfile(sprintf('Italia/I_%dh_%d.jpg',t,n+1),sprintf('Treino%d/treino/%d',i,k));
            end
            if w == i
